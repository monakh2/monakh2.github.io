$(document).ready(function () {
    ...
    var locations = [
        ...
        {name: 'Заведение 2', latitude: 33.890542, longitude: 151.774956, marker: 'tourism', info: resaltBockDiscont},
        {name: 'Заведение 3', latitude: 33.890542, longitude: 152.274856, marker: 'condo', info: resaltBockNoDiscont},
        {name: 'Заведение 4', latitude: 33.890542, longitude: 152.774856, marker: 'spa', info: resaltBockDiscont},
        {name: 'Заведение 5', latitude: 33.890542, longitude: 153.274856, marker: 'beach', info: resaltBockNoDiscont},
        {name: 'Заведение 6', latitude: 34.890542, longitude: 151.274856, marker: 'restaurant', info: resaltBockDiscont},
        {name: 'Заведение 7', latitude: 34.890542, longitude: 151.774956, marker: 'guesthouses', info: resaltBockNoDiscont},
        {name: 'Заведение 8', latitude: 34.890542, longitude: 152.274856, marker: 'transport', info: resaltBockDiscont},
        {name: 'Заведение 9', latitude: 34.890542, longitude: 152.774856, marker: 'shoping', info: resaltBockNoDiscont},
        {name: 'Заведение 10', latitude: 34.890542, longitude: 153.274856, marker: 'hotels', info: resaltBockDiscont}
    ];
